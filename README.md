...
## How to use
  ...
  ### 2. Manually add ID information 
  - Push manual some information from ID card to Firebase server through AddDataToDatabase.py<br />
  ### 3. Learning all user's facial image
  - Run EnccodeGenerator.py to create pickle file which learn from all user's facial image and use it for main.py<br />
  ### 4. Run main.py 
  - Run main.py (use q keyboard to terminate app)<br />
